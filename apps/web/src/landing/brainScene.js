...
const errorEl = document.querySelector('#brainError')
if (!(canvas instanceof HTMLCanvasElement) || !(stage instanceof HTMLElement) || !(loadingEl instanceof HTMLElement) || !(errorEl instanceof HTMLElement)) {
